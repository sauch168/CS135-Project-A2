...
for n=1:length(starplus_data)
    ...
    [picI1,picD1,picM1]=transformIDM_avgROIVoxels(picI1,picD1,picM1,relevantROI);
    [picI2,picD2,picM2]=transformIDM_selectTimewindow(senI,senD,senM,[17:32]);
    [picI2,picD2,picM2]=transformIDM_avgROIVoxels(picI2,picD2,picM2,relevantROI);

    % Sentences
    [senI1,senD1,senM1]=transformIDM_selectTimewindow(picI,picD,picM,[17:32]);
    [senI1,senD1,senM1]=transformIDM_avgROIVoxels(senI1,senD1,senM1,relevantROI);
    [senI2,senD2,senM2]=transformIDM_selectTimewindow(senI,senD,senM,[1:16]);
    [senI2,senD2,senM2]=transformIDM_avgROIVoxels(senI2,senD2,senM2,relevantROI);
