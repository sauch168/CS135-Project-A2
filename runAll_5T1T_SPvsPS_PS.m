...
createTrainingTesting_Active_SPvsPS_ONE;
run5Training1TestingAltSet;
KNN5_accuracies_SPvsPS_PS_active_5T1T = all_accuracies;
KNN5_accuracy_SPvsPS_PS_active_5T1T = overallAccuracy;
KNN5_losses_SPvsPS_PS_active_5T1T = all_losses;
KNN5_loss_SPvsPS_PS_active_5T1T = overallLoss;
classifier = '7nn';
run5Training1TestingAltSet;
KNN7_accuracies_SPvsPS_PS_active_5T1T = all_accuracies;
KNN7_accuracy_SPvsPS_PS_active_5T1T = overallAccuracy;
KNN7_losses_SPvsPS_PS_active_5T1T = all_losses;
KNN7_loss_SPvsPS_PS_active_5T1T = overallLoss;
classifier = '9nn';
run5Training1TestingAltSet;
KNN9_accuracies_SPvsPS_PS_active_5T1T = all_accuracies;
KNN9_accuracy_SPvsPS_PS_active_5T1T = overallAccuracy;
KNN9_losses_SPvsPS_PS_active_5T1T = all_losses;
KNN9_loss_SPvsPS_PS_active_5T1T = overallLoss;

fprintf('SP vs PS label (PS testing set only), ROI Avg\n')
createTrainingTesting_ROIAvg_SPvsPS_ONE;
classifier = '5nn';
run5Training1TestingAltSet;
KNN5_accuracies_SPvsPS_PS_ROIAvg_5T1T = all_accuracies;
KNN5_accuracy_SPvsPS_PS_ROIAvg_5T1T = overallAccuracy;
KNN5_losses_SPvsPS_PS_ROIAvg_5T1T = all_losses;
KNN5_loss_SPvsPS_PS_ROIAvg_5T1T = overallLoss;
classifier = '7nn';
run5Training1TestingAltSet;
KNN7_accuracies_SPvsPS_PS_ROIAvg_5T1T = all_accuracies;
KNN7_accuracy_SPvsPS_PS_ROIAvg_5T1T = overallAccuracy;
KNN7_losses_SPvsPS_PS_ROIAvg_5T1T = all_losses;
KNN7_loss_SPvsPS_PS_ROIAvg_5T1T = overallLoss;
classifier = '9nn';
run5Training1TestingAltSet;
KNN9_accuracies_SPvsPS_PS_ROIAvg_5T1T = all_accuracies;
KNN9_accuracy_SPvsPS_PS_ROIAvg_5T1T = overallAccuracy;
KNN9_losses_SPvsPS_PS_ROIAvg_5T1T = all_losses;
KNN9_loss_SPvsPS_PS_ROIAvg_5T1T = overallLoss;
...
classifier = '7nn';
run5Training1TestingAltSet
KNN7_accuracies_SPvsPS_PS_activeAvg_5T1T = all_accuracies;
KNN7_accuracy_SPvsPS_PS_activeAvg_5T1T = overallAccuracy;
KNN7_losses_SPvsPS_PS_activeAvg_5T1T = all_losses;
KNN7_loss_SPvsPS_PS_activeAvg_5T1T = overallLoss;
classifier = '9nn';
run5Training1TestingAltSet
KNN9_accuracies_SPvsPS_PS_activeAvg_5T1T = all_accuracies;
KNN9_accuracy_SPvsPS_PS_activeAvg_5T1T = overallAccuracy;
KNN9_losses_SPvsPS_PS_activeAvg_5T1T = all_losses;
KNN9_loss_SPvsPS_PS_activeAvg_5T1T = overallLoss;