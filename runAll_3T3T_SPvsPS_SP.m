...
createTrainingTesting_Active_SPvsPS_ONE;
run3Training3TestingAltSet;
KNN5_accuracies_SPvsPS_SP_active_3T3T = all_accuracies;
KNN5_accuracy_SPvsPS_SP_active_3T3T = overallAccuracy;
KNN5_losses_SPvsPS_SP_active_3T3T = all_losses;
KNN5_loss_SPvsPS_SP_active_3T3T = overallLoss;
classifier = '7nn';
run3Training3TestingAltSet;
KNN7_accuracies_SPvsPS_SP_active_3T3T = all_accuracies;
KNN7_accuracy_SPvsPS_SP_active_3T3T = overallAccuracy;
KNN7_losses_SPvsPS_SP_active_3T3T = all_losses;
KNN7_loss_SPvsPS_SP_active_3T3T = overallLoss;
classifier = '9nn';
run3Training3TestingAltSet;
KNN9_accuracies_SPvsPS_SP_active_3T3T = all_accuracies;
KNN9_accuracy_SPvsPS_SP_active_3T3T = overallAccuracy;
KNN9_losses_SPvsPS_SP_active_3T3T = all_losses;
KNN9_loss_SPvsPS_SP_active_3T3T = overallLoss;

fprintf('SP vs PS label (SP testing set only), ROI Avg\n')
createTrainingTesting_ROIAvg_SPvsPS_ONE;
classifier = '5nn';
run3Training3TestingAltSet;
KNN5_accuracies_SPvsPS_SP_ROIAvg_3T3T = all_accuracies;
KNN5_accuracy_SPvsPS_SP_ROIAvg_3T3T = overallAccuracy;
KNN5_losses_SPvsPS_SP_ROIAvg_3T3T = all_losses;
KNN5_loss_SPvsPS_SP_ROIAvg_3T3T = overallLoss;
classifier = '7nn';
run3Training3TestingAltSet;
KNN7_accuracies_SPvsPS_SP_ROIAvg_3T3T = all_accuracies;
KNN7_accuracy_SPvsPS_SP_ROIAvg_3T3T = overallAccuracy;
KNN7_losses_SPvsPS_SP_ROIAvg_3T3T = all_losses;
KNN7_loss_SPvsPS_SP_ROIAvg_3T3T = overallLoss;
classifier = '9nn';
run3Training3TestingAltSet;
KNN9_accuracies_SPvsPS_SP_ROIAvg_3T3T = all_accuracies;
KNN9_accuracy_SPvsPS_SP_ROIAvg_3T3T = overallAccuracy;
KNN9_losses_SPvsPS_SP_ROIAvg_3T3T = all_losses;
KNN9_loss_SPvsPS_SP_ROIAvg_3T3T = overallLoss;
...
classifier = '5nn';
run3Training3TestingAltSet;
KNN5_accuracies_SPvsPS_SP_activeAvg_3T3T = all_accuracies;
KNN5_accuracy_SPvsPS_SP_activeAvg_3T3T = overallAccuracy;
KNN5_losses_SPvsPS_SP_activeAvg_3T3T = all_losses;
KNN5_loss_SPvsPS_SP_activeAvg_3T3T = overallLoss;
classifier = '7nn';
run3Training3TestingAltSet;
KNN7_accuracies_SPvsPS_SP_activeAvg_3T3T = all_accuracies;
KNN7_accuracy_SPvsPS_SP_activeAvg_3T3T = overallAccuracy;
KNN7_losses_SPvsPS_SP_activeAvg_3T3T = all_losses;
KNN7_loss_SPvsPS_SP_activeAvg_3T3T = overallLoss;
classifier = '9nn';
run3Training3TestingAltSet;
KNN9_accuracies_SPvsPS_SP_activeAvg_3T3T = all_accuracies;
KNN9_accuracy_SPvsPS_SP_activeAvg_3T3T = overallAccuracy;
KNN9_losses_SPvsPS_SP_activeAvg_3T3T = all_losses;
KNN9_loss_SPvsPS_SP_activeAvg_3T3T = overallLoss;