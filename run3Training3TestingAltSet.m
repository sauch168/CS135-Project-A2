%% TO BE USED FOR PS VS SP (PS) AND PS VS SP (SP) ONLY
    ...
    for j=n+1:length(starplus_data)
        for k=j+1:length(starplus_data)
            ...
            for l=1:3
                ...
                testingEx = [testingEx; starplus_examples2(testing_set_indices(l)).ex];
                testingL = [testingL; starplus_examples2(testing_set_indices(l)).l];
                testingI = [testingI; starplus_examples2(testing_set_indices(l)).i];
            end
